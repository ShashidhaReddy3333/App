...
export function AdminBusinessesTable({ businesses }: { businesses: BusinessRow[] }) {
  ...
  async function mutateBusiness(
    ...
    try {
      ...
      const message =
        error instanceof ApiClientError ? error.message : "Unable to update business.";
      toast.error(message);
    } finally {
      setPendingKey(null);
    }
      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {businesses.map((business) => {
            ...
            const isBusy =
              pendingKey?.startsWith(business.id) ||
              [suspendKey, activateKey, verifyKey, marketplaceKey].includes(pendingKey ?? "");
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Suspend {business.businessName}? The business and its staff will
                              remain in the system, but platform access will be disabled until it is
                              reactivated.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                              ...
                              onClick={() =>
                                void mutateBusiness(
                                  suspendKey,
                                  { businessId: business.id, isActive: false },
                      ...
                      <Button
                        ...
                        onClick={() =>
                          void mutateBusiness(
                            ...
                            `${business.businessName} activated.`
                          )
                        }
                      >
                        Activate
                    ...
                    <Button
                      ...
                      onClick={() =>
                        void mutateBusiness(
                          ...
                          business.isMarketplaceVisible
                            ? `${business.businessName} hidden from marketplace.`
                            : `${business.businessName} visible in marketplace.`
                        )
                      }
                    >
                    ...
                    {business.verificationStatus !== "approved" ? (
                      <Button
                        ...
                        onClick={() =>
                          void mutateBusiness(
                            verifyKey,
                            { businessId: business.id, verify: true },

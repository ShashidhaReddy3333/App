...
export function AdminAnnouncementsPanel({ announcements }: { announcements: AnnouncementRow[] }) {
  ...
  async function createAnnouncement() {
    ...
    try {
      ...
      const message =
        error instanceof ApiClientError ? error.message : "Unable to create announcement.";
      toast.error(message);
    } finally {
      setPendingKey(null);
    }
  ...
  async function mutateAnnouncement(
    ...
    try {
      ...
      const message =
        error instanceof ApiClientError ? error.message : "Unable to update announcement.";
      toast.error(message);
    } finally {
      setPendingKey(null);
    }
          ...
          <CardContent className="grid gap-4 p-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onChange={(event) =>
                  setFormValues((current) => ({ ...current, audience: event.target.value }))
                }
              >
            ...
            <div className="md:col-span-2">
              <Button
                type="button"
                disabled={
                  pendingKey === "create" || !formValues.title.trim() || !formValues.body.trim()
                }
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
                    ...
                    {announcement.expiresAtLabel ? (
                      <span>{`Expires: ${announcement.expiresAtLabel}`}</span>
                    ) : null}
                  </div>
                </div>

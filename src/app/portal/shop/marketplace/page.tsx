...
import { MarketplacePageClient } from "@/app/marketplace/marketplace-page-client";
            ...
            <CardContent className="flex flex-col items-start gap-4 p-8 sm:flex-row sm:items-center sm:justify-between">
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm text-muted-foreground">
                  Try a different search or category, or return to the shop to browse any active

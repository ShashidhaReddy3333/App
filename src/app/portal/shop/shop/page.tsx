      ...
      <section className="surface-shell rounded-[30px] p-6 sm:p-8">
        ...
        <p className="mt-3 max-w-3xl text-base leading-7 text-muted-foreground">
          {storefront.available
            ...
            : "The storefront is being prepared. Browse active stores in the marketplace or create a customer account to start ordering as soon as products are live."}
        </p>
        {storefront.available ? (
          <div className="pt-4">
            <LocationSwitcher
        ...
        <Card className="border-dashed">
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Browse the public marketplace to discover active businesses, or create a customer
              account so you are ready to order when the storefront opens.
            </p>
